...
def hypertune_ets_model(training_df, y_train, x_train, y_test, testing_df, seasonality, project_name):
    ...
    for estimator in estimators:
        ...
        print(f"MAE for roject={project_name}, estimator={estimator}: {mae:.2f}")
...
def trigger_prediction(df_path, project_name, periodicity=None, seasonality=None):
    ...
    best_model, best_config = hypertune_ets_model(
