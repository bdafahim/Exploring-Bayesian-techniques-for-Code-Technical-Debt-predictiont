...
def simulate_sqale_index_sarima(training_df, best_model_cfg, simulations=100):
    """
    Simulates the SQALE_INDEX based on the ARIMA model.
    ...
    for i in range(simulations):
        model = SARIMAX(actual_sqale_index, order=arima_order, seasonal_order=seasonal_order,
